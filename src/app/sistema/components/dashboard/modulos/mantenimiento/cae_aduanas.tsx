...
import { deleteAduanas, getAduanas, postAduana, putAduana } from "@/app/api/cae_aduanas.api";
...
export default function CaeAduanas() {
    ...
    const [caeAduanas, setCaeAduanas] = useState([] as CaeAduana[]);
    ...
    useEffect(() => {
        if (caeAduanas) {
            ...
            */
            const fields = [
                { label: visibleColumns[keys[0]], key: keys[0], example: '1234', type: 'number' },
                { label: visibleColumns[keys[1]], key: keys[1], example: 'Nombre', type: 'text' },
            ];

            setFormFieldsCration(createFormFields(fields));
            setFormFieldsModification(createFormFields(fields, "ID Cae Aduana", "id_cae_aduana", true));
        ...
        <>
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content flex-col justify-start w-full h-full">
                    ...
                    <ReturnButton
                        className=""
                        onClick={() => setMantenimientoState(0)}
                        text="Regresar"
                    />
