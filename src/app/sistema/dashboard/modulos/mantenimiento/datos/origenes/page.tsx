    ...
    useEffect(() => {
        if (paises.length > 0 && aduana.length > 0) {
            ...
            setFormFields([
                ...
                { label: visibleColumns[keys[1]], key: keys[1], example: 'Ecuador', type: 'text', required: true },
                { label: visibleColumns[keys[2]], key: keys[2], example: 'Aeropuerto', type: 'text', required: true },
