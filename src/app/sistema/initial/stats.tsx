    ...
    return (
        <>
            <div className="stats w-full max-md:stats-vertical max-md:max-w-xs mx-auto shadow ">
                ...
                <div className="stat">
                    <div className="stat-figure text-base-content text-3xl">
                ...
                <div className="stat">
                    ...
                    <div className={"stat-desc " + (users - lastUsers > 0 ? "text-base-content font-semibold" : "")}>↗︎ 427 ({percentageChange}%)</div>
                </div>
